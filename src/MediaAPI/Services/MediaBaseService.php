...
/**
 * Base class for the Media service.
 */
class MediaBaseService extends \DTS\eBaySDK\Services\BaseRestService
{
    /**
     * @var array $endPoints The API endpoints.
     */
    protected static $endPoints = [
        'sandbox'    => 'https://apim.sandbox.ebay.com/commerce/media',
        'production' => 'https://apim.ebay.com/commerce/media'
    ];
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DTS\eBaySDK\MediaAPI\Services\MediaService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
